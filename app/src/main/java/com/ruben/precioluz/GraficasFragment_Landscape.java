...
public class GraficasFragment_Landscape extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.graficas_layout_landscape, container, false);
    ...
    public void pinta_titulo(ViewGroup rootView/*, int tamaño_letra*/){
        TextView TextView_titulo = (TextView) rootView.findViewById(R.id.precios);
        TextView_titulo.setText(this.titulo);
